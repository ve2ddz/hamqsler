...
{
	/// <summary>
	/// UserdefBoolean class - user defined adif field class of type boolean
	/// </summary>
	public class UserdefBoolean : BooleanField
	{
		...
		public UserdefBoolean(string value, Userdef userdefField) : base(value)
		{
