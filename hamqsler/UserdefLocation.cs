...
{
	/// <summary>
	/// UserdefLocation class - user defined adif field that is Location based
	/// </summary>
	public class UserdefLocation : Location
	{
		...
		public UserdefLocation(string loc, Userdef udef) : base(loc)
		{
			userdef = udef;
		}
