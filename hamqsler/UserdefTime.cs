...
{
	/// <summary>
	/// UserdefTime class - user defined adif field of type time
	/// </summary>
	public class UserdefTime : TimeField
	{
		...
		public UserdefTime(string value, Userdef userdefField) : base(value)
		{
