...
namespace hamqslerTest
{
	...
	public class QrzComQsoUploadStatusTests
	{
		...
		public void TestMethod()
		{
			...
			QrzCom_Qso_Upload_Status status = new QrzCom_Qso_Upload_Status("Y", App.AdifEnums);
		...
		public void TestValidateB()
		{
			string err = string.Empty;
			string modStr = string.Empty;
			QrzCom_Qso_Upload_Status status = new QrzCom_Qso_Upload_Status("B", App.AdifEnums);
