...
{
	// tests for Eqsl_Qsl_Sent class
	[TestFixture]
	public class EqslQslSentTests
	{
		// TestFixtureSetup
		[TestFixtureSetUp]
		...
		{
			Eqsl_Qsl_Sent rcvd = new Eqsl_Qsl_Sent("Y", App.AdifEnums);
			Assert.AreEqual("<Eqsl_Qsl_Sent:1>Y", rcvd.ToAdifString());
		}
		...
		public void TestValidateInvalidValue()
		{
			string err = string.Empty;
			string modStr = string.Empty;
			Eqsl_Qsl_Sent rcvd = new Eqsl_Qsl_Sent("F", App.AdifEnums);
